...
import { AddSingleSaleExpenseFunc } from '../../BackendApiCalls/SaleApi'

export default function AddSingleSaleExpenseModal({ Modal, setModal, SaleData, ActionId }) {
    ...
    const handleSubmit = (e) => {
        ...
        if (SelectedStore) {
            ...
            AddSingleSaleExpenseFunc(data, ActionId).then(() => {
                    ...
                    <div className="relative bg-white rounded-lg shadow">
                        ...
                        <div className="max-h-[37rem] overflow-auto scrollbar-thin scrollbar-track-gray-100 scrollbar-thumb-gray-300 scrollbar-medium rounded-scrollbar flex flex-col px-5 pb-5">
                            <div className='border-b py-1'>
                                <h1 className='text-dark-primary text-lg font-semibold relative bottom-3'>{SaleData}</h1>
                            </div>
