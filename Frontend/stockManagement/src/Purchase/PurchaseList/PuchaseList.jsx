...
import { PurchaseListFunc } from '../../BackendApiCalls/PurchaseApi'
...
export default function PurchaseList() {
    ...
    const { CalculatePagination, SearchValue, setSearchValue, dummyState, SelectedStore, formatDate, ParentLoading, setParentLoading } = useContext(GlobalStateContext)
    ...
    useEffect(() => {
        if (SelectedStore) {
            PurchaseListFunc(PageNumber, SelectedStore.id, FromFilterDate, ToFilterDate, SearchValue).then((data) => {
