...
import { ReturnListFunc } from '../../BackendApiCalls/ReturnApi'
import GlobalStateContext from '../../Context/GlobalStateContext'
import SearchField from '../../UI Elemets/SearchField'
import ReturnHeader from '../Partials/ReturnHeader'
...
export default function ReturnList({ component }) {

    const { CalculatePagination, SearchValue, setSearchValue, dummyState, SelectedStore, setReturnType, formatDate, ParentLoading, setParentLoading } = useContext(GlobalStateContext)
    ...
    useEffect(() => {
        ...
        if (SelectedStore) {
            ReturnListFunc(PageNumber, SelectedStore.id, component, FromFilterDate, ToFilterDate, SearchValue).then((data) => {
                setReturnData(data.results)
